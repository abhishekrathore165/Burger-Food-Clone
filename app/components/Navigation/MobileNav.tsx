...
const MobileNav = ({closeNav,showNav}:props) => {
  ...
  return (
    <div className={`fixed ${navStyle} right-0 transition-all duration-500 left-0 top-0 bottom-0 h-[100vh] bg-[#000000e0] z-[1002]`}>
      <ImCross onClick={closeNav} className=' absolute top-[2rem] right-[2rem] h-[2rem] w-[2rem] text-white' />
      {/* nav links */}
      <div className={`bg-emerald-700 transition-all ${navStyle} duration-500 delay-200 flex flex-col items-center justify-center w-[70%] h-[100%]`}>
