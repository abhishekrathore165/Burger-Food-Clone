...
const Feature = () => {
  return (
    <div className='pt-[5rem] pb-[3rem]'>
      ...
      {/* cards */}
      <div className="w-[90%] md:w-[80%] md:mt-[5rem] mb-[3rem] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[3rem]">
        <div data-aos="fade-left" data-aos-anchor-placement="top-center" >
            <div className="p-6 hover:bg-white rounded-lg transition-all duration-200">
               ...
               <p className='mt-[0.2rem] text-black text-opacity-60 text-center'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi repellendus dignissimos natus dolorum voluptas, quas ratione, consectetur, dolore ducimus repudiandae consequuntur optio sapiente aspernatur aperiam.
               </p>
            </div>
        </div>
