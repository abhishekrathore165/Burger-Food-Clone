...
const BurgerCard = ({title,images,price,reviews}:props) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3'>
        <div className="w-[200px] mx-auto h-[200px]">
            <Image src={images} alt={title} width={200} height={200} className='w-[100%] h-[100%] object-cover' />
        </div>
      ...
      <p className="mt-[0.5rem] text-black text-opacity-70">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sit, aperiam!</p>
      <div className="flex mt-[1.4rem] items-center justify-between">
        <h1 className='text-[25px] font-bold text-red-600'>{price}</h1>
        <button className='px-4 py-2 hover:bg-green-700 transition-all duration-200 bg-orange-600 items-center flex text-center rounded-md text-white'>
